...
---Standard version contains 4 compile targets, std_win is to be used on the windows platform, 
 ...
 --- Extended version basically changed the interpreter into a game.
    I have not been able to embed libraries inside the program other than on windows, so     
    there should be
     ...
     Because of SDL, the program is more stable on windows than on mac, normally it will        
     work on both platforms. on windows it is compiled using mingw.
